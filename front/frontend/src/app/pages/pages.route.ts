...
import { ListePComponent } from "./liste-p/liste-p.component";
...
export const PAGE_ROUTES: Route[] = [
    ...
    { path: 'apps-gestionprojet', component: GestionProjetComponent },
    { path: 'apps-listeprojet', component: ListePComponent },
    { path: 'apps-listep', component: ListePComponent },
    { path: 'apps-planaction',component:PlanActionComponent},
