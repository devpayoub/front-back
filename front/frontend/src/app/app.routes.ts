...
import { ListePComponent } from './pages/liste-p/liste-p.component';
import { PlanActionComponent } from './pages/plan-action/plan-action.component';
...
import { MissionComponent } from './pages/hr/mission/mission.component';
import { DocumentComponent } from './pages/hr/documents/documents.component';
export const routes: Routes = [
    ...
    { path: 'gestion-projet/:idProjet', component: GestionProjetComponent },
