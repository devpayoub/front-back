...
function TooltipComponent_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r0.value);
  }
}
function TooltipComponent_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵproperty("innerHTML", ctx_r0.value, ɵɵsanitizeHtml);
  }
}
...
TooltipComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 4,
  vars: 3,
  consts: [["htmlOrStringTemplate", ""], ["class", "tooltip-arrow", 4, "ngIf"], [4, "ngIf", "ngIfElse"], [1, "tooltip-arrow"], [4, "ngTemplateOutlet"], [3, "innerHTML"]],
  template: function TooltipComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, TooltipComponent_div_0_Template, 1, 0, "div", 1)(1, TooltipComponent_div_1_Template, 2, 1, "div", 2)(2, TooltipComponent_ng_template_2_Template, 1, 1, "ng-template", null, 0, ɵɵtemplateRefExtractor);
    }
    if (rf & 2) {
      const htmlOrStringTemplate_r2 = ɵɵreference(3);
      ɵɵproperty("ngIf", ctx.isThemeLight);
      ɵɵadvance();
      ɵɵproperty("ngIf", ctx.options["contentType"] === "template")("ngIfElse", htmlOrStringTemplate_r2);
    }
  },
