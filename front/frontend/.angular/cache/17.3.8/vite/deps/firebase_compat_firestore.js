  ...
  nn(e) {
    ...
    if (this.Zt.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.sn(e2, t2) || !this.on(this.Xt[s++], t2))
          return false;
      }
      ++i;
    }
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.En(i2), r));
    } else
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 17) {
    ...
    this.Ei = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.D())
  ...
  vi() {
    return __async(this, null, function* () {
      if (this.isPrimary && !this.Fi(this.Ti, 18e5)) {
        ...
        if (this.Ri)
          for (const t of e)
            this.Ri.removeItem(this.xi(t.clientId));
      }
    });
  }
  /**
  ...
  runTransaction(e, t, n) {
    ...
    return this.Ai.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.qr ? this.qr.next() : __PRIVATE_ListenSequence.oe), "readwrite-primary" === t ? this.yi(s).next((e2) => !!e2 || this.wi(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.ai.enqueueRetryable(() => this.Ei(false)), new FirestoreError(C.FAILED_PRECONDITION, F);
      return n(s);
  ...
  Qi(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.Fi(e2.leaseTimestampMs, 5e3) && !this.Oi(e2.ownerId) && !this.Di(e2) && !(this.ci || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(C.FAILED_PRECONDITION, Ve);
    });
  }
  /**
...
var __PRIVATE_QueryEngine = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r) {
    ...
    return this.Ji(e, t).next((e2) => {
      ...
      if (!i.result)
        return this.Yi(e, t, r, n).next((e2) => {
          i.result = e2;
        });
    }).next(() => {
      if (i.result)
      ...
      return this.Zi(e, t, n2).next((r2) => {
        if (i.result = r2, this.Gi)
          return this.Xi(e, t, n2, r2.size);
      });
    }).next(() => i.result);
  }
  Xi(e, t, n, r) {
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      ...
      if (t2)
        return i = t2.lastLimboFreeSnapshotVersion, r.$r.getMatchingKeysForTargetId(e2, t2.targetId).next((e3) => {
          s = e3;
        });
  ...
  return __async(this, arguments, function* (e, t, n = __PRIVATE_documentKeySet()) {
    ...
    return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
      ...
      if (r.snapshotVersion.compareTo(s) >= 0)
        return i.Wr.saveNamedQuery(e2, t);
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  ys(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.bs)
  ...
  Hs(e) {
    return __async(this, null, function* () {
      if (e.user.uid === this.currentUser.uid)
        return this.syncEngine.eo(e.batchId, e.state, e.error);
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          __PRIVATE_logDebug(ge, `RPC '${e}' stream ${r} received:`, i2), P.So(i2);
      }
...
var __PRIVATE_BundleLoader = class {
  ...
  ca(e) {
    ...
    if (e._a.namedQuery)
      ...
      e._a.document && (this.documents[this.documents.length - 1].document = e._a.document, ++t);
...
function __PRIVATE_syncEngineUnlisten(e, t, n) {
  return __async(this, null, function* () {
    ...
    if (s.length > 1)
      return r.Fa.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.va.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r of e.Fa.get(t))
    e.va.delete(r), n && e.Ca.Ka(r, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      e.Na.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  Du(e) {
    ...
    if (__PRIVATE_isWrite(this.yu) && be.test(e))
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.yu)
      throw 1 === e.yu ? e.Fu(`${this._methodName}() can only appear at the top level of your update data`) : e.Fu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseData(e, t) {
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n))
        throw t2.Fu(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
